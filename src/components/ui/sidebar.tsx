  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "bg-sidebar text-sidebar-foreground flex h-full w-52 flex-col",
          className
        )}
        {...props}
      >
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:ml-1 md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2",
        "md:peer-data-[state=collapsed]:ml-16",
        className
      )}
      {...props}
    />

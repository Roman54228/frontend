  ...
  const navItems = [
    {
      title: "Interview",
      items: [
        { title: "Interview Copilot", icon: Monitor, href: "#copilot" },
        { title: "Mock Interview", icon: MessageSquare, href: "#mock" },
      ]
    },
    {
      title: "Tools",
      items: [
        { title: "AI Resume Builder", icon: FileText, href: "#resume" },
        { title: "AI Material Generator", icon: Wand2, href: "#generator" },
        { title: "AI Job Hunter", icon: Briefcase, href: "#jobs" },
        { title: "AI Salary Calculator", icon: Calculator, href: "#salary" },
      ]
    },
    {
      title: "Resources",
      items: [
        { title: "Preparation Hub", icon: User, href: "#prep" },
        { title: "Question Bank", icon: HelpCircle, href: "#questions" },
      ]
    }
  ];
    ...
    },
    {
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-12 w-12">
          ...
          <path d="M9.6 15.6H16.8" stroke="currentColor" strokeWidth="2.4" strokeLinecap="square"/>
        </svg>
      ),
